        ...
        <section id="invitation">
            <div className="invitation-inner">
                ...
                <p className="inv-text reveal">
                    ...
                    <br /><br />
                    Сіздерді аяулы қызымыз <br /><strong><em>Елназдың</em></strong> <br />ата-анасының аялы алақанынан құтты босағасына шығарып салу рәсіміне арналған салтанатты ақ дастарханымыздың қадірлі қонағы болуға шақырамыз!
                </p>
